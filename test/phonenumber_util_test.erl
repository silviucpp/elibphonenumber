...
format_mx_number_test() ->
    ...
    <<"12345678900">> = phonenumber_util:format(P12, national),
    <<"+52 12345678900">> = phonenumber_util:format(P12, international),
    ...
    <<"15512345678">> = phonenumber_util:format(P22, national),
    <<"+52 15512345678">> = phonenumber_util:format(P22, international),
